...
![Image of Overwatch 2](/static/files/ScAI/fullscreen_training_room2.png)  
...
the kill symbol,  
![An image of the kill symbol which is a red skull.](/static/files/ScAI/kill_shot.png)  
the headshot symbol,  
![An image of the headshot symbol which is 4 diagonal red lines going outwards, centered at the crosshair.](/static/files/ScAI/headshot_plain.png)  
and the bodyshot symbol.  
![An image of the bodyshot symbol which is the same as the headshot symbol except the lines are slightly shorter and they are white instead of red.](/static/files/ScAI/body_shot.png)  
If there is no symbol around the crosshair, then that means you missed.  
![An image of just the crosshair because if you miss there is no symbol.](/static/files/ScAI/miss.png)  
...
![An image showing a bodyshot plus a kill, which is a red skull with the white diagonal lines of a body shot.](/static/files/ScAI/bodyshot_kill.png)  
...
![An image showing what the health looks like.](/static/files/ScAI/health_full.png)  
